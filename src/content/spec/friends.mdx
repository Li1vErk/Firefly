...
export const site = {
  name: "Cyarin's ImgBed",
  desc: "๑ᐢ..ᐢ๑",
  url: "https://cloudflare-imgbed.cyarin128.workers.dev/",
  avatar: "https://cloudflare-imgbed.cyarin128.workers.dev/file/Blog/1779891962077_导航栏logo.png",
  email: "xiaye@msn.com",
};
